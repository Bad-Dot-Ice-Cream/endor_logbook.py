...
if not os.path.exists(LOG_PATH):
    with open(LOG_PATH, "w", encoding="utf-8") as f:
        f.write("# Ender Logbook - created at " + datetime.now() .isoformat() + "\n")

    # Function to briefly demonstrate each mode used for file-handling.
def prove_modes():
    print("\n=== Proving Modes ===")
    ...
    # Code for returning back previous encounters and saving written entries.
class Logbook:
    ...
    def read_all(self) -> list[str]:
        ...
        # Searching for keywords of previous encounters.
    ...
    # An organized set of random encounters to be saved.
ENCOUNTERS = [
...
def random_encounter() -> str:
    ...
    # All of the appearence and functionality related code for the menu inputs.
def menu():
